...
const inviteCode_1 = require("../util/inviteCode");
(0, node_test_1.default)('invite codes round-trip and validate checksum', () => {
    const userId = 'user_01HXY9KZ2ZQ8W3R9S5T6U7V8W9';
    const code = (0, inviteCode_1.makeInviteCode)(userId);
    const parsed = (0, inviteCode_1.parseInviteCode)(code);
    ...
    strict_1.default.equal((0, inviteCode_1.parseInviteCode)(bad), null);
});
