...
const feedbackPolicy_1 = require("../coaching/feedbackPolicy");
(0, node_test_1.default)('resolveFeedbackPlan: beginner stays forgiving but tightens over weeks', () => {
    const w1 = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'beginner', week: 1, base: null });
    const w12 = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'beginner', week: 12, base: null });
...
(0, node_test_1.default)('resolveFeedbackPlan: advanced reduces overlay progressively; OFF_POST only for transfer later weeks', () => {
    const w2core = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'advanced', week: 2, base: null, segment: 'core' });
    const w8core = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'advanced', week: 8, base: null, segment: 'core' });
    const w10core = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'advanced', week: 10, base: null, segment: 'core' });
    const w10transfer = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'advanced', week: 10, base: null, segment: 'transfer' });
...
(0, node_test_1.default)('resolveFeedbackPlan: lesson base mode is respected and bandwidth is tightened by progression', () => {
    const p = (0, feedbackPolicy_1.resolveFeedbackPlan)({ track: 'advanced', week: 10, base: { mode: 'FADED', bandwidthCents: 40, fadeAfterSec: 1.5 } });
...
(0, node_test_1.default)('applyFeedbackPlanToDrill clones drill and applies tune window', () => {
    ...
    const out = (0, feedbackPolicy_1.applyFeedbackPlanToDrill)(d, p);
...
(0, node_test_1.default)('isTransferLikeDrillId detects phrase/melody drills', () => {
    strict_1.default.equal((0, feedbackPolicy_1.isTransferLikeDrillId)('song_phrase_twinkle_a'), true);
    strict_1.default.equal((0, feedbackPolicy_1.isTransferLikeDrillId)('melody_1'), true);
    strict_1.default.equal((0, feedbackPolicy_1.isTransferLikeDrillId)('sustain_a3_steady'), false);
});
