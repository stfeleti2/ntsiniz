...
export function getWeeklyChallenges(now = Date.now()): { weekKey: string; challenges: WeeklyChallenge[] } {
...
export function getWeeklyChallengeById(id: string): WeeklyChallenge | null {
