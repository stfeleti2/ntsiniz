import type { FlowScenario, FlowScenarioId, ViewportPreset } from "./types"
...
export const flowScenarios: Record<FlowScenarioId, FlowScenario> = {
  onboarding: {
    id: "onboarding",
...
export const flowScenarioList = Object.values(flowScenarios)
